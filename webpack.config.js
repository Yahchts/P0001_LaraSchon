...
module.exports = (env, argv) => {
	...
	const DEFAULTS = { description: 'Skin care products are formulated to work with all skin types, not against them. Our luxurious cruelty-free skin care cosmetics delivers real results without side effects.', keywords: 'keywords' };
